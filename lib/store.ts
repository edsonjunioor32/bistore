 ...
 * de ambiente ou preencher os mesmos dados pelo menu Configurações.
 */
export const storeConfig: StoreConfig = {
  name: process.env.NEXT_PUBLIC_STORE_NAME ?? "Bi Store",
  ...
  primaryColor: process.env.NEXT_PUBLIC_STORE_PRIMARY_COLOR ?? "#1D1C1B",
  secondaryColor: process.env.NEXT_PUBLIC_STORE_SECONDARY_COLOR ?? "#E76C5F",
  currency: "BRL",
  locale: "pt-BR",
  ...
  instagram: process.env.NEXT_PUBLIC_STORE_INSTAGRAM ?? "@bi_storeuse",
};
